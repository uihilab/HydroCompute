    ...
    switch (char) {
      case "scatter":
        for (var k = 0; k < d[0].length; k++) {
          temp.push(typeof params.names !== "undefined" ? params.names[k] : `Value${k}`);
        }
        d.unshift(temp);
      ...
      case "line" || "timeline":
        ...
        for (var k = 1; k < d[0].length; k++) {
          //WILL NEED CHANGE LATER
          temp.push({label: typeof params.names !== "undefined" ? params.names[k-1] : `Value_item${k}`, type: 'number'});
        }
